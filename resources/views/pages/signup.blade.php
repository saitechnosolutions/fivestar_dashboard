									...
									<div class="form-body mt-3">
										...
										<form class="row g-3" method="POST" action="/store">
											...
											<div class="col-sm-6">
												...
												<input type="text" class="form-control" id="inputLastName" name="mblnum" placeholder="Mobile Number">
											</div>
											<div class="col-12">
											...
											<div class="col-12">
												...
												<select class="form-select" id="inputSelectCountry" name="role" aria-label="Default select example">
