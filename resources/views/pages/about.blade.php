    ...
    <div class="page-content">
        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-6">
                        <form method="POST" action="/updateContent" enctype="multipart/form-data">
                            @csrf
                    ...
                    <div class="col-lg-6">
                        ...
                        <form method="POST" action="/updateContent" enctype="multipart/form-data">
                            @csrf
                            <textarea style="height:400px" id="mytextarea" class="form-control" name="abtcontent">{{$about->abt_content}}</textarea>
                            <button type="submit" class="btn btn-success mt-3">Update Content</button>
                        </form>
                    ...
                    <div class="col-lg-6">
                        ...
                        <form method="POST" action="/updateContent" enctype="multipart/form-data">
                            @csrf
                            <textarea  style="height:400px" class="form-control" name="whychooseus">{{$about->why_choose_us}}</textarea>
                            <button type="submit" class="btn btn-success mt-3">Update Content</button>
                        </form>
                    ...
                    <div class="col-lg-6">
                        ...
                        <form method="POST" action="/updateContent" enctype="multipart/form-data">
                            @csrf
                            <textarea  style="height:400px" class="form-control" name="who_we_are">{{$about->who_we_are}}</textarea>
                            <button type="submit" class="btn btn-success mt-3">Update Content</button>
                        </form>
